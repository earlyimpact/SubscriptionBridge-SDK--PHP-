<?php
$sbCCPageName="Add Metered";
$sbButtonName="Add Metered";
$sbFormAction="client.amr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("AddMeteredRequest","AddMeteredRequestXML",$gv_EndPoint_Management);
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Meter Link ID: </td>
                        <td><input class="sbInputField" name="LinkID" type="text" value="TxtLinkID"></td>
                    </tr>
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Memo: </td>
                        <td><textarea name="Memo" class="sbInputField"></textarea></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
