<?php
$sbCCPageName="Add Feature Request";
$sbButtonName="Add Feature Request";
$sbFormAction="client.afr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("AddFeatureRequest","AddFeatureRequestXML",$gv_EndPoint_Management);
