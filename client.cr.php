<?php
$sbCCPageName="Cancellation Request";
$sbButtonName="Cancellation Request";
$sbFormAction="client.cr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("CancellationRequest","CancellationRequestXML",$gv_EndPoint_Management);
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Reason:  </td>
                        <td><textarea class="sbSelectField" name="Reason" cols="40" rows="5"></textarea></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
