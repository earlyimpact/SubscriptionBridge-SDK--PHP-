<?php
$sbCCPageName="Modify Account Credentials Request";
$sbButtonName="Modify Account Credentials Request";
$sbFormAction="client.mac.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("ModifyAccountCredentialsRequest","ModifyAccountCredentialsRequestXML",$gv_EndPoint_Authentication);
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                        ...
                        <td><input class="sbInputField"  name="NewPassword" type="text" value="test"></td>
                    </tr> 
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
