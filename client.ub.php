<?php
$sbCCPageName="Update Subscription";
$sbButtonName="Update Subscription";
$sbFormAction="client.ub.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("UpdateSubscriptionRequest","UpdateSubscriptionRequestXML",$gv_EndPoint_Management);
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td colspan="2"><h2>Customer (Optional)</h2></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2"><h2>Credit Card (Optional)</h2></td>
                    </tr>
                    <tr>
