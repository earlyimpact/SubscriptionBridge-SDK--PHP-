<?php
$sbCCPageName="Check Account Available Request";
$sbButtonName="Check Account Available Request";
$sbFormAction="client.caa.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("CheckAccountAvailableRequest","CheckAccountAvailableRequestXML",$gv_EndPoint_Authentication);
