<?php
$sbCCPageName="Get Subscriptions Request";
$sbButtonName="Get Subscriptions Request";
$sbFormAction="client.gsr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("GetSubscriptionsRequest","GetSubscriptionsRequestXML",$gv_EndPoint_Management);
