<?php
$sbCCPageName="Get Timestamp";
$sbButtonName="Get Timestamp";
$sbFormAction="client.time.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("GetTimeRequest","GetTimeRequestXML",$gv_EndPoint_Subscriptions);
