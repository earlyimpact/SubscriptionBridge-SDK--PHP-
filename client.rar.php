<?php
$sbCCPageName="Remove Adjustement Request";
$sbButtonName="Remove Adjustement Request";
$sbFormAction="client.rar.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("RemoveAdjustmentRequest","RemoveAdjustmentRequestXML",$gv_EndPoint_Management);
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td colspan="2"><h2>Adjustment</h2></td>
                    </tr>
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Adjustment ID: </td>
                        <td><input class="sbInputField" name="AdjustmentID" type="text" value=""></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
