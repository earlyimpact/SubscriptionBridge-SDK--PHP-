<?php
$sbCCPageName="Get Features Request";
$sbButtonName="Get Features Request";
$sbFormAction="client.gf.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("GetFeaturesRequest","GetFeaturesRequestXML",$gv_EndPoint_Subscriptions);
