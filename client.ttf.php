<?php
$sbCCPageName="Trial To Full";
$sbButtonName="Trial To Full";
$sbFormAction="client.ttf.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("TrialToFullRequest","TrialToFullRequestXML",$gv_EndPoint_Management);
