<?php
$sbCCPageName="Get Subscription Details";
$sbButtonName="Get Subscription Details";
$sbFormAction="client.gsdr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("GetSubscriptionDetailsRequest","GetSubscriptionDetailsRequestXML",$gv_EndPoint_Management);
