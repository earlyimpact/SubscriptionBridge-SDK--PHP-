<?php
$sbCCPageName="Sample Login Page";
$sbButtonName="Sample Login Page";
$sbFormAction="client.slip.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->SubscriptionRequest();
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td colspan="2"><p>NOTE:  In Production your credentials would not be form fields.</p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td colspan="2"><h2>Sample Login Form</h2></td>
                    </tr> 
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Email: </td>
                        <td><input class="sbInputField"  name="Email" type="text" value="SimpleEIGTest1"></td>
                    </tr>
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Password: </td>
                        <td><input class="sbInputField"  name="Password" type="text" value="SimpleEIGTest1"></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
