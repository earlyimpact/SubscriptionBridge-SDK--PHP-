<?php
$sbCCPageName="Get Packages Request";
$sbButtonName="Get Packages Request";
$sbFormAction="client.gpr.php";
?>
<?php include("header.php"); ?>
			...
			If ($_SERVER['CONTENT_LENGTH'] > 0) {
				...
				$result = $objSB->Request("GetPackagesRequest","GetPackagesRequestXML",$gv_EndPoint_Subscriptions);
        	...
        	<?php } Else { ?>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2">
                  <form action="<?php echo $sbFormAction ?>" method="post" class="sbForms">
                    ...
                    <tr>
                    	<td class="leftCell" nowrap="nowrap">Language Code:  </td>
                        <td>
                          	<select class="sbSelectField" name="LanguageCode" id="LanguageCode">
                            	<option value="1" selected="selected">en-US</option>
                        	</select>&nbsp;*
                        </td>
                    </tr>
                    <tr>
